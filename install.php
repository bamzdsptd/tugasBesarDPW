...
$hapus = mysqli_query($link,"DROP DATABASE bigProject");
if ($hapus)
    {
...
$buat = mysqli_query($link,'CREATE DATABASE bigProject');
if ($buat)
    {
...
$gunakan = mysqli_query($link,'USE bigProject');
if ($gunakan)
    {
...
$tabel_login = mysqli_query($link, $users);

$user = mysqli_query($link,"INSERT INTO admin VALUES ('admin', 'admin')"); 
